...
public int hashCode()
{
    ...
    hash = 67 * hash + this.numDocto;
    hash = 67 * hash + (this.fechaDocto != null ? this.fechaDocto.hashCode() : 0);
    hash = 67 * hash + (this.codCliente != null ? this.codCliente.hashCode() : 0);
    hash = 67 * hash + (this.saldo != null ? this.saldo.hashCode() : 0);
    return hash;
}
