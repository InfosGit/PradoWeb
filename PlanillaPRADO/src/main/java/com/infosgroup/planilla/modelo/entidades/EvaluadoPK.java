...
{
    int hash = 5;
    hash = 17 * hash + (int) (this.codCia ^ (this.codCia >>> 32));
    hash = 17 * hash + (int) (this.evaluador ^ (this.evaluador >>> 32));
    hash = 17 * hash + (int) (this.periodo ^ (this.periodo >>> 32));
    hash = 17 * hash + (int) (this.campania ^ (this.campania >>> 32));
    hash = 17 * hash + (int) (this.tipoEvaluacion ^ (this.tipoEvaluacion >>> 32));
    hash = 17 * hash + (int) (this.plantilla ^ (this.plantilla >>> 32));
    hash = 17 * hash + (int) (this.codEmp ^ (this.codEmp >>> 32));
    return hash;
}
