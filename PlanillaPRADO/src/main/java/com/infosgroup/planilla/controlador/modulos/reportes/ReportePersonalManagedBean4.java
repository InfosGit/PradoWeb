 ...
 * @author root
 */
@ManagedBean(name = "reportes$reportePersonal4")
@ViewScoped
public class ReportePersonalManagedBean4 extends AbstractJSFPage implements Serializable {
    ...
    public String generarReporte$action() {
        ...
        reportesBean.generarReporteSQL(FacesContext.getCurrentInstance(), parametros, "RPLA163", FormatoReporte.PDF);
        return null;
    }
}