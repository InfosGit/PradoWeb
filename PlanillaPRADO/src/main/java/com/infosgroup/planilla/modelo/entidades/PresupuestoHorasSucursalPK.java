...
{
    return "com.infosgroup.planilla.modelo.entidades.PresupuestoHorasSucursalPK[ codCia=" + codCia + ", anio=" + anio + ", mes=" + mes + ", correlat=" + correlat + " ]";
}
}
