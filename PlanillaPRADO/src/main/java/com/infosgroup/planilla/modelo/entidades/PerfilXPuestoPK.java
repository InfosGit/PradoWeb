...
{
    int hash = 3;
    hash = 11 * hash + this.codCia;
    hash = 11 * hash + this.codPuesto;
    hash = 11 * hash + this.codPerfil;
    return hash;
}
...
{
    return "com.infosgroup.planilla.modelo.entidades.PerfilXPuestoPK[ codCia=" + codCia + ", codPuesto=" + codPuesto + ", codPerfil=" + codPerfil + " ]";
}
}
