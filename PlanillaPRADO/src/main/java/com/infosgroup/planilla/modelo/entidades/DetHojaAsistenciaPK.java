...
public int hashCode()
{
    ...
    hash = 53 * hash + this.noHoja;
    hash = 53 * hash + this.codEmp;
    hash = 53 * hash + this.noSerie;
    return hash;
}
...
{
    return "com.infosgroup.planilla.modelo.entidades.DetHojaAsistenciaPK[ codCia=" + codCia + ", noHoja=" + noHoja + ", codEmp=" + codEmp + ", noSerie=" + noSerie + " ]";
}
}
