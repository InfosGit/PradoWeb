...
{
    int hash = 7;
    hash = 17 * hash + this.codCia;
    hash = 17 * hash + this.anio;
    hash = 17 * hash + (this.tipoObra != null ? this.tipoObra.hashCode() : 0);
    hash = 17 * hash + this.codObra;
    hash = 17 * hash + this.subProy;
    hash = 17 * hash + this.codSupervi;
    return hash;
}
