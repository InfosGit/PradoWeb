...
{
    int hash = 7;
    hash = 31 * hash + this.codCia;
    hash = 31 * hash + this.codEmp;
    hash = 31 * hash + (this.fechaInicial != null ? this.fechaInicial.hashCode() : 0);
    hash = 31 * hash + (this.fechaFinal != null ? this.fechaFinal.hashCode() : 0);
    hash = 31 * hash + (this.fecha != null ? this.fecha.hashCode() : 0);
    hash = 31 * hash + (this.horaInicial != null ? this.horaInicial.hashCode() : 0);
    hash = 31 * hash + (this.horaFinal != null ? this.horaFinal.hashCode() : 0);
    return hash;
}
