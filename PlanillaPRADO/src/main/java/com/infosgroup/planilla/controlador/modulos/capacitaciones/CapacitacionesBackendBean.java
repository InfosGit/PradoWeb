...
private BigDecimal costoParticipante;
private Long fteFinanciamiento;
...
public BigDecimal getCostoParticipante()
{
    return costoParticipante;
}

public void setCostoParticipante(BigDecimal costoParticipante)
{
    this.costoParticipante = costoParticipante;
}

public Long getFteFinanciamiento()
{
    return fteFinanciamiento;
}

public void setFteFinanciamiento(Long fteFinanciamiento)
{
