...
// @Max(value=?)  @Min(value=?)//if you know range of your decimal fields consider using these annotations to enforce field validation
    ...
    @Column(name = "COD_TIPO_INCAPACIDAD")
    private Integer codTipoIncapacidad;
    @Column(name = "HRS_NORMAL_DIURNA")
    private Integer hrsNormalDiurna;
    @Column(name = "HRS_EXTRA_DIURNA")
    private Integer hrsExtraDiurna;
    @Column(name = "HRS_NORMAL_NOCTURNA")
    private Integer hrsNormalNocturna;
    @Column(name = "HRS_EXTRA_NOCTURNA")
    private Integer hrsExtraNocturna;
    ...
    {
        if ((getStatus() != null) && getStatus().matches("G"))
            {
            accEstado = "Solicitada";
            }
        else
            {
            if ((getStatus() != null) && getStatus().matches("J"))
                {
                accEstado = "Pre-Aprobada";
                }
            else
                {
                if ((getStatus() != null) && getStatus().matches("R"))
                    {
                    accEstado = "Rechazada";
                    }
                else
    ...
    public Integer getCodTipoIncapacidad()
    {
        return codTipoIncapacidad;
    }

    public void setCodTipoIncapacidad(Integer codTipoIncapacidad)
    {
        this.codTipoIncapacidad = codTipoIncapacidad;
    }

    public Integer getHrsNormalDiurna()
    {
        return hrsNormalDiurna;
    }

    public void setHrsNormalDiurna(Integer hrsNormalDiurna)
    {
        this.hrsNormalDiurna = hrsNormalDiurna;
    }

    public Integer getHrsExtraDiurna()
    {
        return hrsExtraDiurna;
    }

    public void setHrsExtraDiurna(Integer hrsExtraDiurna)
    {
        this.hrsExtraDiurna = hrsExtraDiurna;
    }

    public Integer getHrsNormalNocturna()
    {
        return hrsNormalNocturna;
    }

    public void setHrsNormalNocturna(Integer hrsNormalNocturna)
    {
        this.hrsNormalNocturna = hrsNormalNocturna;
    }

    public Integer getHrsExtraNocturna()
    {
        return hrsExtraNocturna;
    }

    public void setHrsExtraNocturna(Integer hrsExtraNocturna)
    {
        this.hrsExtraNocturna = hrsExtraNocturna;
    }
