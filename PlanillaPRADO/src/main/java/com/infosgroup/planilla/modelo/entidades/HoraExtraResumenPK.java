...
public int hashCode()
{
    ...
    hash = 97 * hash + (this.fechaInicial != null ? this.fechaInicial.hashCode() : 0);
    hash = 97 * hash + (this.fechaFinal != null ? this.fechaFinal.hashCode() : 0);
    return hash;
}
...
{
    return "com.infosgroup.planilla.modelo.entidades.HoraExtraResumenPK[ codCia=" + codCia + ", codEmp=" + codEmp + ", fechaInicial=" + fechaInicial + ", fechaFinal=" + fechaFinal + " ]";
}
}
