...
public int hashCode()
{
    ...
    hash = 59 * hash + this.periodo;
    hash = 59 * hash + this.correlativo;
    return hash;
}
...
{
    return "com.infosgroup.planilla.modelo.entidades.PlanCarreraPK[ codCia=" + codCia + ", periodo=" + periodo + ", correlativo=" + correlativo + " ]";
}
}
