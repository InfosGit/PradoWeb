...
{
    int hash = 7;
    hash = 29 * hash + (this.codCia != null ? this.codCia.hashCode() : 0);
    hash = 29 * hash + (this.codCandidato != null ? this.codCandidato.hashCode() : 0);
    hash = 29 * hash + (this.codNivel != null ? this.codNivel.hashCode() : 0);
    return hash;
}
