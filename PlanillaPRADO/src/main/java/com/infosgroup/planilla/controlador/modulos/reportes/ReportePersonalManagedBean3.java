 ...
 * @author root
 */
@ManagedBean(name = "reportes$reportePersonal3")
@ViewScoped
public class ReportePersonalManagedBean3 extends AbstractJSFPage implements Serializable {
    ...
    public String generarReporte$action() {
        ...
        reportesBean.generarReporteSQL(FacesContext.getCurrentInstance(), parametros, "RPLA162", FormatoReporte.PDF);
        return null;
    }
}