...
public PlantillaPK(long codCia, int codTipoEvaluacion, long codPlantilla)
{
    this.codCia = codCia;
...
{
    int hash = 5;
    hash = 53 * hash + (int) (this.codCia ^ (this.codCia >>> 32));
    hash = 53 * hash + this.codTipoEvaluacion;
    hash = 53 * hash + (int) (this.codPlantilla ^ (this.codPlantilla >>> 32));
    return hash;
}
...
{
    return "com.infosgroup.planilla.modelo.entidades.planilla.PlantillaPK[ codCia=" + codCia + ", codTipoEvaluacion=" + codTipoEvaluacion + ", codPlantilla=" + codPlantilla + " ]";
}
}
