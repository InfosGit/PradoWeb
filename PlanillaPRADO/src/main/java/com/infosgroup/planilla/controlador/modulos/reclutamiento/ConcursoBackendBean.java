...
//private DataTable tableConcursos;
    ...
    public void _init()
    {
        ...
        listaEstadoConcurso = reclutamientoFacade.getEstadoConcursosByEmpresa(getSessionBeanEMP().getCompania());
        listaConcursos = reclutamientoFacade.getConcursoByEmpresa(getSessionBeanEMP().getCompania());
    }
...
//    }
    ...
    {
        List<EstadoConcurso> k = reclutamientoFacade.getEstadoConcursosByEmpresa(getSessionBeanEMP().getCompania());
    ...
    public String guardar$crud$action()
    {
        ...
        if (getSessionBeanADM().getEstadoAccion() == null || getSessionBeanADM().getEstadoAccion().equals(0))
            ...
            pk.setCodCia(c);
            pk.setCodConcurso(reclutamientoFacade.getMaxConcurso(getSessionBeanEMP().getCompania()));
