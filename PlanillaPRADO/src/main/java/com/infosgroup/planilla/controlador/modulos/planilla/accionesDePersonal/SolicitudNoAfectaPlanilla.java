...
public void _init()
{
    if (isInRole("rrhh"))
        {
        listaTipoAccionNoAfecta = getPlanillaSessionBean().listarTipoAccionNoAfectaPlanilla(getSessionBeanEMP().getCompania(), "rrhh");
        }
    else if (isInRole("jefes"))
        {
        listaTipoAccionNoAfecta = getPlanillaSessionBean().listarTipoAccionNoAfectaPlanilla(getSessionBeanEMP().getCompania(), "jefes");
        }
    else if (isInRole("empleados"))
        {
        listaTipoAccionNoAfecta = getPlanillaSessionBean().listarTipoAccionNoAfectaPlanilla(getSessionBeanEMP().getCompania(), "empleados");
        }
    else
        {
...
public String guardarSolicitud$action()
{
    ...
    TipoAccion tipoAccion = new TipoAccion(new TipoAccionPK(getSessionBeanEMP().getCompania().getCodCia(), tipoAccionSeleccionada));
    accionPersonal.setAccionPersonalPK(getAccionPersonalPK(getSessionBeanEMP().getCompania(), tipoAccion, getEmpleadosToAccionPersonal()));
