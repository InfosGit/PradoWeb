...
public int hashCode()
{
    ...
    hash = 97 * hash + this.codPerfil;
    hash = 97 * hash + this.codItemPerfil;
    return hash;
}
...
{
    return "com.infosgroup.planilla.modelo.entidades.ItemXPerfilPK[ codCia=" + codCia + ", codPerfil=" + codPerfil + ", codItemPerfil=" + codItemPerfil + " ]";
}
}
