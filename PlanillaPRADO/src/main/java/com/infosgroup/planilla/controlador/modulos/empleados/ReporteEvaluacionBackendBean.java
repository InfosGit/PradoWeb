...
{
    listaCampanias = empleadosSessionBean.findAllByCia(getSessionBeanEMP().getCompania().getCodCia());
...
//        }
    ...
    reportesBean.generarReporteSQL(FacesContext.getCurrentInstance(), parametros, "reporteEvaluacion", FormatoReporte.PDF);
    return null;
}
