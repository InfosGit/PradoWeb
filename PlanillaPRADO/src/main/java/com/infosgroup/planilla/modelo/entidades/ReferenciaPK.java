...
public int hashCode()
{
    ...
    hash = 97 * hash + this.codCandidato;
    hash = 97 * hash + this.codReferencia;
    return hash;
}
...
{
    return "com.infosgroup.planilla.modelo.entidades.ReferenciaPK[ codCia=" + codCia + ", codCandidato=" + codCandidato + ", codReferencia=" + codReferencia + " ]";
}
}
