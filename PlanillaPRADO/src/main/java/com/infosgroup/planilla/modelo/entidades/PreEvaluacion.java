...
@OneToMany(cascade = CascadeType.ALL, mappedBy = "preEvaluacion")
...
public boolean equals(Object object)
{
    ...
    if ((this.preEvaluacionPK == null && other.preEvaluacionPK != null) || (this.preEvaluacionPK != null && !this.preEvaluacionPK.equals(other.preEvaluacionPK)))
        {
        return false;
        }
    return true;
