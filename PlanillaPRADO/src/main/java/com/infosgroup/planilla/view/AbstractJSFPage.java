...
public String getManifiestoCorreo(AprobarSolicitud.APRUEBA eaprueba, AccionPersonal a)
{
    ...
    mensaje.append("\n\nAtte. \n\nDepartamento de Recursos Humanos ").append(getSessionBeanEMP().getCompania().getNomComercial());
    return mensaje.toString();
}

public boolean usuarioEnRol(String rol)
{
...
public boolean getUsuarioRRHH()
{    
       return FacesContext.getCurrentInstance().getExternalContext().isUserInRole("rrhh");
}
