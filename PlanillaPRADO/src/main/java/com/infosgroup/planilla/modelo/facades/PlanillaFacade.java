...
{
    List<Planilla> listPla = em.createQuery("SELECT p FROM Planilla p WHERE p.planillaPK.codCia = :codCia AND p.planillaPK.codEmp = :codEmp AND p.planillaPK.codTipopla = :codTipopla ORDER BY p.planillaPK.anio DESC", Planilla.class)
