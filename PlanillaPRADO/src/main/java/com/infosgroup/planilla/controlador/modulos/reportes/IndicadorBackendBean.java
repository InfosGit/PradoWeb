...
public String aplicar()
{
    ...
    indicadorBean.calcularIndicadores(getSessionBeanEMP().getCompania(), fechaInicial, fechaFinal);
    setModelIndicadores(indicadorBean.listaIndicadores(getSessionBeanEMP().getCompania()));
    return null;
}
