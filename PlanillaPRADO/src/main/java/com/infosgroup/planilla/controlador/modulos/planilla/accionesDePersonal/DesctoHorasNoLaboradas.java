 ...
 * @author root
 */
@ManagedBean(name = "desctoHorasNoLaboradas")
@ViewScoped
public class DesctoHorasNoLaboradas extends SolicitudDePersonal implements java.io.Serializable
{
    ...
    public String guardarSolicitud$action()
    {
        ...
        accionPersonal.setHrsNormalDiurna(diurnasSencillas);
        accionPersonal.setHrsExtraDiurna(diurnasExtras);
        accionPersonal.setHrsNormalNocturna(nocturnasSencillas);
        accionPersonal.setHrsExtraNocturna(nocturnasExtras);
