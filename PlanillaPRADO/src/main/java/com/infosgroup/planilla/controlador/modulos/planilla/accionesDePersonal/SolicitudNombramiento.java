...
public String guardarSolicitud$action()
{
    ...
    accionPersonal.setNuevoDepartamento(new Departamentos(new DepartamentosPK(getSessionBeanEMP().getCompania().getCodCia(), departamento)));
    accionPersonal.setPuestos(getEmpleadosToAccionPersonal().getPuestos());
    accionPersonal.setNuevoPuesto(new Puestos(new PuestosPK(getSessionBeanEMP().getCompania().getCodCia(), puesto)));
