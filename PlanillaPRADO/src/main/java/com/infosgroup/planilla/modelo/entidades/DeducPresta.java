...
// @Max(value=?)  @Min(value=?)//if you know range of your decimal fields consider using these annotations to enforce field validation
    ...
    public DeducPresta(DeducPrestaPK deducPrestaPK, String vpr, String cta1, String cta2, String cta3, String cta4, String cta5)
    {
        this.deducPrestaPK = deducPrestaPK;
        this.vpr = vpr;
        this.cta1 = cta1;
    ...
    public String getDescripcionSumaResta()
    {
        ...
        if (sumaResta != null)
            {
            if (sumaResta.equalsIgnoreCase("S"))
                {
                descripcionSumaResta = "Suma";
                }
            if (sumaResta.equalsIgnoreCase("R"))
                {
                descripcionSumaResta = "Resta";
                }
            }
