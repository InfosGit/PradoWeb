...
{
    int hash = 3;
    hash = 83 * hash + (int) (this.codCia ^ (this.codCia >>> 32));
    hash = 83 * hash + (int) (this.codFactor ^ (this.codFactor >>> 32));
    hash = 83 * hash + (this.codPregunta != null ? this.codPregunta.hashCode() : 0);
    return hash;
}
