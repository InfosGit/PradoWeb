...
{
    listaTipoAccion = getPlanillaSessionBean().listaTipoAccionRetiro(getSessionBeanEMP().getCompania());
...
{
    listaCausasRenuncia = getPlanillaSessionBean().findCausasRenunciasByCias(getSessionBeanEMP().getCompania());
...
public String guardarSolicitud$action()
{
    ...
    accionPersonal.setAccionPersonalPK(getAccionPersonalPK(getSessionBeanEMP().getCompania(), new TipoAccion(new TipoAccionPK(getSessionBeanEMP().getCompania().getCodCia(), accion)), getEmpleadosToAccionPersonal()));
    accionPersonal.setTipoAccion(new TipoAccion(new TipoAccionPK(getSessionBeanEMP().getCompania().getCodCia(), accion)));
    ...
    accionPersonal.setCausasRenuncia(new CausasRenuncia(new CausasRenunciaPK(getSessionBeanEMP().getCompania().getCodCia(), tipoRenuncia)));
