...
//
    ...
    @Column(name = "NUM_IRTRA", length = 50)
...
//    private String departamento;
    ...
    @Column(name = "PUEDE_ENTREVISTAR", length = 1)
    private String puedeEntrevistar;
    @Size(max = 30)
    @Column(name = "NUM_PASAPORTE", length = 30)
    private String numPasaporte;
//
// Nuevas columnas (por el candidato)
...
//
    ...
    @Column(name = "ACTIVIDAD_LIMITADA")
    private String actividadLimitada;
    @Column(name = "TIENE_ACCIDENTE")
    private String tieneAccidente;
    ...
    /*
     * @OneToMany(cascade = CascadeType.ALL, mappedBy = "empleados") private List<Evaluacion> evaluacionList;
     */
    @JoinColumn(name = "COD_CIA", referencedColumnName = "COD_CIA", nullable = false, insertable = false, updatable = false)
    @ManyToOne(optional = false)
    private Cias cias;
...
//    private Integer representantePatronal;
    @JoinTable(name = "EQUIPO_X_EMP", joinColumns =
        {
        @JoinColumn(name = "COD_CIA", referencedColumnName = "COD_CIA", nullable = false),
...
//    }
    ...
    public String getPuedeEntrevistar()
    {
        return puedeEntrevistar;
    }

    public void setPuedeEntrevistar(String puedeEntrevistar)
    {
        this.puedeEntrevistar = puedeEntrevistar;
    }
    ...
    public String getActividadLimitada()
    {
        return actividadLimitada;
    }

    public void setActividadLimitada(String actividadLimitada)
    {
        this.actividadLimitada = actividadLimitada;
    }

    public String getTieneAccidente()
    {
        return tieneAccidente;
    }

    public void setTieneAccidente(String tieneAccidente)
    {
        this.tieneAccidente = tieneAccidente;
    }
