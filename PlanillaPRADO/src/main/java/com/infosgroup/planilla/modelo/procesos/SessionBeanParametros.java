...
@PermitAll
public List<NivelAcademico> findAllNivelAcademicos(Cias cia)
{
    return nivelAcademicoFacade.findNivelesByEmpresa(cia);
}
...
{
    return profesionesFacade.findProfesionByEmpresa(cia);
}
...
@PermitAll
public List<Empleados> findEmpleadosPuedenEntrevistar(Cias cia)
{
    return empleadoFacade.findByPuedeEntrevistar(cia);
}
